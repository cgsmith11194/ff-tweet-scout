...
#   - Status must be IN, OUT, or PENDING (anything else renders as a gray badge)
...
| Drake London | WR · ATL | PENDING | PCL sprain | 4:05 game — expected, no reported cap; actives ~2:35 ET |
| JAX@DEN · LV@HOU · PIT@DET |  | PENDING | — | No fantasy-relevant GTDs reported; actives ~2:55 ET |
| SF@IND | MNF | PENDING | — | Statuses land Monday; posted to the Discord |
